...
public class Triangulo extends Figura {
  public Triangulo() {
    ...
    public Triangulo(String nombre, LinkedList<Punto> puntos) {
        super(nombre, puntos);
    }
               /**    
*Nombre: DibujarFigura()
 *Objetivo: pinta el triangulo en el archivo
 ...
 */
    ...
    protected void DibujarFigura(LinkedList <Punto>punti, String NombreArch) {
        ...
        System.out.println("Escogió el triangulo, este se representará con el caracter .");
        File archivo;
